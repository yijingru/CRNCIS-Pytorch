...
class ResNetSSD(nn.Module):
    ...
    def forward(self, x):
        """
        ----------
        torch.Size([2, 512, 64, 80])
        tensor(0., device='cuda:0', grad_fn=<MinBackward1>)
        tensor(5.5308, device='cuda:0', grad_fn=<MaxBackward1>)
        -------------
        torch.Size([2, 1024, 32, 40])
        tensor(0., device='cuda:0', grad_fn=<MinBackward1>)
        tensor(3.2839, device='cuda:0', grad_fn=<MaxBackward1>)
        -------------
        torch.Size([2, 512, 16, 20])
        tensor(0., device='cuda:0', grad_fn=<MinBackward1>)
        tensor(5.1996, device='cuda:0', grad_fn=<MaxBackward1>)
        -------------
        torch.Size([2, 256, 8, 10])
        tensor(0., device='cuda:0', grad_fn=<MinBackward1>)
        tensor(4.2920, device='cuda:0', grad_fn=<MaxBackward1>)
        -------------
        """
        x = self.conv1(x)
        x = self.bn1(x)
